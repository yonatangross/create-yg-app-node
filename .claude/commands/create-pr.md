---
description: Create PR with validation and auto-generated description
---

# Create Pull Request

Comprehensive PR creation with validation. **NO file creation** - all output goes directly to GitHub PR.
...
**CRITICAL: Run ALL checks locally before creating PR.**
...
5. **Keep it simple** - One command to create PR
